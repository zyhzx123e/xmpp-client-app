...
public class XmppTool {
    ...
    //public static final String HOST = "123.207.145.194";
     public static final String HOST = "192.168.43.23";
        ...
        try {
            if (con.isConnected()) {// 首先判断是否还连接着服务器，需要先断开
                try {
                    ...
                    Log.i(tag, "conn.disconnect() failed: " + e);
            ...
            con.addConnectionListener(new ConnectionListener() {
                ...
                public void reconnectionFailed(Exception arg0) {
                    // TODO Auto-generated method stub
                    SLog.i(tag, "重连失败");
                    Log.i(tag, "xmpp reconnectionFailed :"+arg0.getMessage());
...
//                    login(user.getUser(), user.getPassword());
                ...
                public void reconnectingIn(int arg0) {
                    // TODO Auto-generated method stub
                    SLog.i(tag, "重连中");
                    Log.i(tag, "xmpp reconnectingIn :"+arg0);
                }
                ...
                public void connectionClosedOnError(Exception e) {
                    ...
                    Log.i(tag, "xmpp connectionClosedOnError :"+e.getMessage());
//                    User user = SaveUserUtil.loadAccount(context);
//                    login(user.getUser(), user.getPassword());
                }
            ...
            Log.e(tag, "xmpp XMPPException e: "+e.getMessage()+" ");
        }
    }
